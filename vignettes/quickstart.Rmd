...
```{r,eval=F}
devtools::install_github("mabafaba/hypegrammaR",build_opts = c(), ref = "training")
```
...
sampling_frame<-read.csv(file = "../tests/testthat/test_samplingframe.csv",stringsAsFactors = F)
```
...
```{r}
koboquestions<-read.csv("../tests/testthat/test_questionnaire_questions.csv")
kobochoices<-  read.csv("../tests/testthat/test_questionnaire_choices.csv")
