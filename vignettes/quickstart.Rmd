...
```{r,eval=F}
remotes::install_github("ellieallien/hypegrammaR",build_opts = c(), ref = "master")
```
...
source_expenses_informal_settlements<-map_to_result(data = assessment_data,
                      dependent.var = "sourceexpenses",
...
```{r, warning=F}
source_expenses_informal_settlements<-map_to_labeled(result = source_expenses_informal_settlements,
                                                questionnaire = questionnaire)
```
...
```{r, warning=F}
chart<- map_to_visualisation(source_expenses_informal_settlements)
table<-map_to_table(source_expenses_informal_settlements)
chart
table
