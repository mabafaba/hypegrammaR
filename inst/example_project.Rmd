...
## Experienced
```{r,echo=F,asis=T,warning=FALSE}
case<-map_to_case(hypothesis.type = 'direct_reporting',dependent.var.type = 'categorical',independent.var.type = 'categorical')

edu1<-map_to_result(assessment_data,dependent.var = "hhexperienced",independent.var = 'region',case = case)
...
hypegrammaR:::percent_with_confints_select_multiple('hhexperienced',design)

grep("hhexperienced.activeconflictviolence",names(assessment_data),value = T,fixed = T)
